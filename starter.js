...
const calculator = (num1, num2, callback) => {
    if (+num1 && +num2) {
        ...
        console.log('Error. Please only enter numbers.')
    }
}
...
// CODE HERE
// Function factory (higher order function)
const makeSandwichMaker = (bread) => {
    return (ingredients) => {
...
// console.log(makeWheatSandwich(['mayo', 'bacon', 'lettuce']))
...
// takes a string as an argument and converts to camel case
const copyStrToCamelCase = str => {
    // split the string into an array of each word
    const splitStr = str.split(' ')
    // define the final result (empty for now)
    let camelCaseStr = ''
...
// console.log(copyStrToCamelCase('well that didnt make any fkin sense'))
